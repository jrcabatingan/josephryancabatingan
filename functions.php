...
// Nutshell Directory constant
define('NUTS_PREFIX', 'nuts');
define('NUTS_LIB', TEMPLATEPATH . '/library');
define('NUTS_LIB_URI', get_template_directory_uri() . '/library');
define('NUTS_CORE', NUTS_LIB . '/core');
define('NUTS_CORE_URI', NUTS_LIB_URI . '/core');
define('NUTS_HTML', NUTS_CORE . '/html');
define('NUTS_HTML_URI', NUTS_CORE_URI . '/html');
define('NUTS_API', NUTS_CORE . '/api');
define('NUTS_API_URI', NUTS_CORE_URI . '/api');
define('NUTS_PLUG', NUTS_CORE . '/plugins');
define('NUTS_PLUG_URI', NUTS_CORE_URI . '/plugins');
define('NUTS_CSS', NUTS_CORE . '/css');
define('NUTS_CSS_URI', NUTS_CORE_URI . '/css');
define('NUTS_JS', NUTS_CORE . '/js');
define('NUTS_JS_URI', NUTS_CORE_URI . '/js');

// Nuthsell pluggable constant
define('NUTS_PLUG_RWMB', NUTS_PLUG . '/meta-box');
define('NUTS_PLUG_RWMB_URI', NUTS_PLUG_URI . '/meta-box');

// Nutshell Custom CSS/JavsScript
function nuts_scripts() {
	
	wp_register_script( 'nutshell-excanvas-js', NUTS_JS_URI . '/excanvas.js', array('jquery'), '1.0', true );
	wp_register_script( 'nutshell-cookie-js', NUTS_JS_URI . '/jquery.cookie.js', array('jquery'), '1.0', true );
	wp_register_script( 'nutshell-chosen-js', NUTS_JS_URI . '/jquery.chosen.min.js', array('jquery'), '1.0', true );
	wp_register_script( 'nutshell-cleditor-js', NUTS_JS_URI . '/jquery.cleditor.min.js', array('jquery'), '1.0', true );
	wp_register_script( 'nutshell-dataTables-js', NUTS_JS_URI . '/jquery.dataTables.min.js', array('jquery'), '1.0', true );
	wp_register_script( 'nutshell-elfinder-js', NUTS_JS_URI . '/jquery.elfinder.min.js', array('jquery'), '1.0', true );
	wp_register_script( 'nutshell-flot-js', NUTS_JS_URI . '/jquery.flot.min.js', array('jquery'), '1.0', true );
	wp_register_script( 'nutshell-flotpie-js', NUTS_JS_URI . '/jquery.flot.pie.min.js', array('jquery'), '1.0', true );
	wp_register_script( 'nutshell-flotresize-js', NUTS_JS_URI . '/jquery.flot.resize.min.js', array('jquery'), '1.0', true );
	wp_register_script( 'nutshell-flotstack-js', NUTS_JS_URI . '/jquery.flot.stack.js', array('jquery'), '1.0', true );
	wp_register_script( 'nutshell-gritter-js', NUTS_JS_URI . '/jquery.gritter.min.js', array('jquery'), '1.0', true );
	wp_register_script( 'nutshell-imagesloaded-js', NUTS_JS_URI . '/jquery.imagesloaded.js', array('jquery'), '1.0', true );
	wp_register_script( 'nutshell-iphonetoggle-js', NUTS_JS_URI . '/jquery.iphone.toggle.js', array('jquery'), '1.0', true );
	wp_register_script( 'nutshell-knob-js', NUTS_JS_URI . '/jquery.knob.js', array('jquery'), '1.0', true );
	wp_register_script( 'nutshell-masonry-js', NUTS_JS_URI . '/jquery.masonry.min.js', array('jquery'), '1.0', true );
	wp_register_script( 'nutshell-noty-js', NUTS_JS_URI . '/jquery.noty.js', array('jquery'), '1.0', true );
	wp_register_script( 'nutshell-raty-js', NUTS_JS_URI . '/jquery.raty.min.js', array('jquery'), '1.0', true );
	wp_register_script( 'nutshell-sparkline-js', NUTS_JS_URI . '/jquery.sparkline.min.js', array('jquery'), '1.0', true );
	wp_register_script( 'nutshell-uniform-js', NUTS_JS_URI . '/jquery.uniform.min.js', array('jquery'), '1.0', true );
	wp_register_script( 'nutshell-uploadify-js', NUTS_JS_URI . '/jquery.uploadify-3.1.min.js', array('jquery'), '1.0', true );
	
	wp_register_style( 'nutshell-campaign-single', NUTS_CSS_URI . '/campaign-single.css' );
	
	wp_enqueue_style( 'nutshell', NUTS_CSS_URI . '/nutshell.css' );
	wp_enqueue_style( 'nutshell-responsive', NUTS_CSS_URI . '/nutshell-responsive.css' );
}
add_action( 'wp_enqueue_scripts', 'nuts_scripts' );

// APIs
require_once(NUTS_API . '/api.seomoz.php');
require_once(NUTS_API . '/api.ahrefs.php');
require_once(NUTS_API . '/api.brightlocal.php');

// Plugin Includes
require_once(NUTS_PLUG_RWMB . '/meta-box.php');

// Page Includes
require_once(NUTS_CORE . '/admin.functions.php');
require_once(NUTS_CORE . '/dashboard.php');
require_once(NUTS_CORE . '/campaign-add.php');
require_once(NUTS_CORE . '/campaign-single.php');

#TODO: needs an alternative solution rather copying from wp-login.php
# Check later for future reference: http://wordpress.stackexchange.com/questions/6402/is-there-any-way-to-rename-or-hide-wp-login-php
# Possibble candidate solution: 
#	http://wordpress.org/extend/plugins/stealth-login/
#	http://wordpress.org/extend/plugins/login-security-solution/
//require_once(NUTS_PLUG . '/login-framework/login.php');
//require_once(NUTS_CORE . '/login.php');
?>
